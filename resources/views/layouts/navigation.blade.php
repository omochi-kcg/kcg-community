    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('discord-servers.index')" :active="request()->routeIs('discord-servers.index')">
                    Discordサーバ
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('boards.board')" :active="request()->routeIs('boards.board')">
                    掲示板
                </x-responsive-nav-link>
                @if (Auth::check())
                <x-responsive-nav-link :href="route('users.edit', Auth::user())" :active="request()->routeIs('users.edit', Auth::user())">
                    ユーザー編集
                </x-responsive-nav-link>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
